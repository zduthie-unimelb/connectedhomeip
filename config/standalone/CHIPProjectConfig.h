...
// Enable to turn off security functionality and add deterministic
// behaviour to facilitate fuzzing.
//
...
#define CHIP_CONFIG_SECURITY_FUZZ_LOGGING 1

// Acknowledge check PASE1 message
#define CHIP_CONFIG_SECURITY_FUZZ_SEED_BUG_1 1
